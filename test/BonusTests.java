...
public class BonusTests {
    ...
    @Test
    public void TestInsurePerson() {
        assertThrows(IllegalArgumentException.class, () -> {
            // Proposed premium is <= 0
            insurer.insurePerson("1", person1, 0, PremiumPaymentFrequency.ANNUAL, Set.of(person2));
        });
        assertThrows(IllegalArgumentException.class, () -> {
            // Proposed Payment Frequency is null
            insurer.insurePerson("1", person1, 1, null, Set.of(person2));
        });
        assertThrows(IllegalArgumentException.class, () -> {
            // Persons to insure is null
            insurer.insurePerson("1", person1, 1, PremiumPaymentFrequency.ANNUAL, null);
        });
        assertThrows(IllegalArgumentException.class, () -> {
            // Persons to insure is empty
            insurer.insurePerson("1", person1, 1, PremiumPaymentFrequency.ANNUAL, Set.of());
        });
        assertThrows(IllegalArgumentException.class, () -> {
            // Yearly premium is low
            insurer.insurePerson("1", person1, 1, PremiumPaymentFrequency.ANNUAL, Set.of(person2));
        });
        TravelContract c1 = insurer.insurePerson("1", person1, 6, PremiumPaymentFrequency.ANNUAL, Set.of(person2));
        assertThrows(IllegalArgumentException.class, () -> {
            // Contract number is used
            insurer.insurePerson("1", person1, 7, PremiumPaymentFrequency.ANNUAL, Set.of(person2));
        });
    ...
    public void TestChargePremiumOnContracts() {
        TravelContract c1 = insurer.insurePerson("1", person1, 5, PremiumPaymentFrequency.ANNUAL, Set.of(person2));
    ...
    public void TestProcessClaim() {
        ...
        assertEquals(10000, person3.getPaidOutAmount());
